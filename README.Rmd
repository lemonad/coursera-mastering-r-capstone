...
[![Build Status](https://travis-ci.com/lemonad/coursera-mastering-r-capstone.svg?branch=main)](https://travis-ci.com/lemonad/coursera-mastering-r-capstone)
...
[the database](https://www.ngdc.noaa.gov/hazel/view/hazards/earthquake/search)
and performing a search. In the top left corner of the result there is an
icon for downloading the results as a tab-separated file.


### Cleaning
Assuming the dataset has been downloaded as `earthquakes.tsv`,
the data can be cleaned using the function `eq_clean_data` which returns
a dataframe that can be subsequentially filtered, etc.
